# Nguyên tắc Karpathy (chuẩn hành vi viết code chung)

Các nguyên tắc hành vi giúp giảm những lỗi phổ biến khi LLM viết code, đúc kết từ
[quan sát của Andrej Karpathy](https://x.com/karpathy/status/2015883857489522876)
về các cạm bẫy khi LLM viết code. Áp dụng cho toàn bộ dự án — cả landing page lẫn
client portal.

**Đánh đổi:** Các nguyên tắc này thiên về sự thận trọng hơn là tốc độ. Với các tác
vụ đơn giản, hãy tự cân nhắc.
...
> Bản gốc tiếng Anh (dùng làm skill có thể gọi riêng): [`karpathy-guidelines`](../skills/karpathy-guidelines/SKILL.md).
